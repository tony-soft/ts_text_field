...
/// * [TsCupertinoAdaptiveTextSelectionToolbar.getAdaptiveButtons], which builds
///   the Cupertino button Widgets for the current platform given
///   [ContextMenuButtonItem]s.
class TsCupertinoAdaptiveTextSelectionToolbar extends StatelessWidget {
  /// Create an instance of [TsCupertinoAdaptiveTextSelectionToolbar] with the
  /// given [children].
  ///
  /// See also:
  ///
  /// {@template flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.buttonItems}
  /// * [TsCupertinoAdaptiveTextSelectionToolbar.buttonItems], which takes a list
  ...
  /// {@endtemplate}
  const TsCupertinoAdaptiveTextSelectionToolbar({
    super.key,
    required this.children,
    required this.anchors,
  }) : buttonItems = null;

  /// Create an instance of [TsCupertinoAdaptiveTextSelectionToolbar] whose
  ...
  const TsCupertinoAdaptiveTextSelectionToolbar.buttonItems({
    super.key,
  ...
  /// {@macro flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.selectable}
  TsCupertinoAdaptiveTextSelectionToolbar.editable({
    super.key,
  ...
  /// {@macro flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.buttonItems}
  /// {@macro flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.selectable}
  TsCupertinoAdaptiveTextSelectionToolbar.editableText({
    super.key,
    required TsEditableTextState editableTextState,
  }) : children = null,
  ...
  /// {@macro flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.editable}
  /// {@macro flutter.cupertino.CupertinoAdaptiveTextSelectionToolbar.editableText}
  TsCupertinoAdaptiveTextSelectionToolbar.selectable({
    super.key,
    required VoidCallback onCopy,
    required VoidCallback onSelectAll,
