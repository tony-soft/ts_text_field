...
class TsCupertinoSpellCheckSuggestionsToolbar extends StatelessWidget {
  /// Constructs a [TsCupertinoSpellCheckSuggestionsToolbar].
  ///
  /// [buttonItems] must not contain more than three items.
  const TsCupertinoSpellCheckSuggestionsToolbar({
    super.key,
    required this.anchors,
    required this.buttonItems,
  }) : assert(buttonItems.length <= _kMaxSuggestions);

  /// Constructs a [TsCupertinoSpellCheckSuggestionsToolbar] with the default
  ...
  TsCupertinoSpellCheckSuggestionsToolbar.editableText({
    super.key,
  ...
  static void _replaceText(TsEditableTextState editableTextState, String text, TextRange replacementRange) {
