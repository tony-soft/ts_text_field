...
import 'package:ts_text_field/src/cupertino/ts_adaptive_text_selection_toolbar.dart';
...
class _CupertinoTextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _CupertinoTextFieldSelectionGestureDetectorBuilder({
    required _TsCupertinoTextFieldState state,
  }) : _state = state,
        super(delegate: state);

  final _TsCupertinoTextFieldState _state;
...
///
/// {@tool dartpad}
/// This example shows how to set the initial value of the [TsCupertinoTextField] using
...
class TsCupertinoTextField extends StatefulWidget {
  ...
  ///  * [maxLength], which discusses the precise meaning of "number of
  ///    characters" and how it may differ from the intuitive meaning.
  const TsCupertinoTextField.borderless({
    super.key,
    this.controller,
    this.focusNode,
    this.undoController,
  ...
  static Widget _defaultContextMenuBuilder(BuildContext context, TsEditableTextState editableTextState) {
    return TsCupertinoAdaptiveTextSelectionToolbar.editableText(
  ...
  ///    [TsCupertinoTextField].
  ///  * [SpellCheckConfiguration.spellCheckSuggestionsToolbarBuilder], the
  ///    parameter for which this is the default value for [TsCupertinoTextField].
  ///  * [TextField.defaultSpellCheckSuggestionsToolbarBuilder], which is like
  ///    this but specifies the default for [TsCupertinoTextField].
  @visibleForTesting
  ...
  @override
  State<TsCupertinoTextField> createState() => _TsCupertinoTextFieldState();
  ...
  static TsSpellCheckConfiguration inferIOSSpellCheckConfiguration(
    ...
    return configuration.copyWith(
      misspelledTextStyle: configuration.misspelledTextStyle
          ?? TsCupertinoTextField.cupertinoMisspelledTextStyle,
      misspelledSelectionColor: configuration.misspelledSelectionColor
          ?? TsCupertinoTextField.kMisspelledSelectionColor,
      spellCheckSuggestionsToolbarBuilder:
      configuration.spellCheckSuggestionsToolbarBuilder
          ?? TsCupertinoTextField.defaultSpellCheckSuggestionsToolbarBuilder,
    );
  }
}

class _TsCupertinoTextFieldState extends State<TsCupertinoTextField> with RestorationMixin, AutomaticKeepAliveClientMixin<TsCupertinoTextField> implements TextSelectionGestureDetectorBuilderDelegate, AutofillClient {
  ...
  @override
  void didUpdateWidget(TsCupertinoTextField oldWidget) {
      ...
      child: RepaintBoundary(
        child: UnmanagedRestorationScope(
          ...
          child: TsEditableText(
            ...
            magnifierConfiguration: widget.magnifierConfiguration ?? TsCupertinoTextField._iosMagnifierConfiguration,
