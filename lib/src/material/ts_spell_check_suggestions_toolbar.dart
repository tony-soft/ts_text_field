...
class TsSpellCheckSuggestionsToolbar extends StatelessWidget {
  /// Constructs a [TsSpellCheckSuggestionsToolbar].
  ///
  /// [buttonItems] must not contain more than four items, generally three
  /// suggestions and one delete button.
  const TsSpellCheckSuggestionsToolbar({
    super.key,
    required this.anchor,
    required this.buttonItems,
  }) : assert(buttonItems.length <= _kMaxSuggestions + 1);

  /// Constructs a [TsSpellCheckSuggestionsToolbar] with the default children for
  /// an [EditableText].
  ///
  /// See also:
  ///  * [CupertinoSpellCheckSuggestionsToolbar.editableText], which is similar
  ///    but builds an iOS-style toolbar.
  TsSpellCheckSuggestionsToolbar.editableText({
    super.key,
