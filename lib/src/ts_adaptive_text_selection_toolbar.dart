...
class TsAdaptiveTextSelectionToolbar extends StatelessWidget {
  /// Create an instance of [TsAdaptiveTextSelectionToolbar] with the
  /// given [children].
  ///
  /// See also:
  ///
  /// {@template flutter.material.AdaptiveTextSelectionToolbar.buttonItems}
  /// * [TsAdaptiveTextSelectionToolbar.buttonItems], which takes a list of
  ...
  /// {@endtemplate}
  const TsAdaptiveTextSelectionToolbar({
    super.key,
    required this.children,
    required this.anchors,
  }) : buttonItems = null;

  /// Create an instance of [TsAdaptiveTextSelectionToolbar] whose children will
  ...
  const TsAdaptiveTextSelectionToolbar.buttonItems({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  TsAdaptiveTextSelectionToolbar.editable({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.buttonItems}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  TsAdaptiveTextSelectionToolbar.editableText({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editable}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editableText}
  TsAdaptiveTextSelectionToolbar.selectable({
    super.key,
    required VoidCallback onCopy,
    required VoidCallback onSelectAll,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editableText}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  TsAdaptiveTextSelectionToolbar.selectableRegion({
    super.key,
