...
///
/// * The [controller]'s [TsTextEditingController.value] will be updated with the
...
class TsEditableText extends StatefulWidget {
  ...
  /// [TsTextEditingController.addListener].
  ///
...
class TsEditableTextState extends State<TsEditableText>
    with AutomaticKeepAliveClientMixin<TsEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<TsEditableText>, TextSelectionDelegate
  ...
  void _openInputConnection() {
    log('openInputConnection() _shouldCreateInputConnection = $_shouldCreateInputConnection, _hasInputConnection = $_hasInputConnection');
    if (!_shouldCreateInputConnection) {
      return;
    }
    if (!_hasInputConnection) {
